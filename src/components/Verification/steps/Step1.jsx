            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-1 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
                />
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-50"
                />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <label
                  ...
                  className="w-full px-10 py-2 border border-gray-300 rounded-lg cursor-pointer text-white flex items-start justify-start space-x-2"
                >
                  <img src="/src/assets/svg/upload.svg" alt="Upload" className="w-8 h-10" />
                  <div className="text-start">
                    <div className="font-semibold text-sm">Upload Kartu Pelajar</div>
                    <div className="text-sm">Kamu Disini!</div>
